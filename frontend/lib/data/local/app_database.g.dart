...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [users, tours, tourMembers, expenses, expenseSplits];
}
...
class $$UsersTableTableManager extends RootTableManager<
    ...
    PrefetchHooks Function(
        {bool tourMembersRefs, bool expensesRefs, bool expenseSplitsRefs})> {
...
class $$ToursTableTableManager extends RootTableManager<
    ...
    Tour,
    PrefetchHooks Function({bool tourMembersRefs, bool expensesRefs})> {
  $$ToursTableTableManager(_$AppDatabase db, $ToursTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: (
              {tourMembersRefs = false, expensesRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (tourMembersRefs) db.tourMembers,
...
class $$ExpensesTableTableManager extends RootTableManager<
    ...
    Expense,
    PrefetchHooks Function(
        {bool tourId, bool payerId, bool expenseSplitsRefs})> {
  $$ExpensesTableTableManager(_$AppDatabase db, $ExpensesTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: (
              {tourId = false, payerId = false, expenseSplitsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (expenseSplitsRefs) db.expenseSplits
