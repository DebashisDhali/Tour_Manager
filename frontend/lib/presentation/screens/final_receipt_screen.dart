          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Center(
                  child: pw.Text(tour.name, style: const pw.TextStyle(fontSize: 18)),
                ),
                pw.Center(
                  child: pw.Text(
                    tour.startDate == null 
                ...
                pw.Divider(),
                pw.Center(
                  child: pw.Text('Generated by Manager', style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey)),
                ),
              ],
            ),
          );
          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 8),
                pw.Center(child: pw.Text(tour.name, style: const pw.TextStyle(fontSize: 18))),
                ...
                pw.Spacer(),
                pw.Divider(),
                pw.Center(child: pw.Text('Generated by Manager', style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey))),
              ],
            ),
          );
        },
